...
func (indexRepo indexRepo) InitDB() httperors.HttpErr {
	...
	GormDB, err := gorm.Open(mysql.New(mysql.Config{
		DSN: sdb.DbUsername + ":" + sdb.DbPassword + "@tcp(order_database:3306)/" + sdb.DbName + "?charset=utf8&parseTime=True&loc=Local", // data source name
	...
	GormDB.AutoMigrate(&model.Order{}, &model.Item{})
	return nil
}
